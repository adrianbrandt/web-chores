...
describe('resendVerificationCode', () => {
    it('should resend verification code successfully with email', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        mockCtx.db.user.update.mockResolvedValue(Object.assign(Object.assign({}, user), { verificationCode: '123456', verificationExpires: new Date() }));
        const result = yield userService.resendVerificationCode(ctx, '1');
    ...
    it('should resend verification code successfully with phone number', () => __awaiter(void 0, void 0, void 0, function* () {
        const user = (0, testData_1.createMockUser)({
            isVerified: false,
            email: null,
    ...
    it('should throw error if user does not exist', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield expect(userService.resendVerificationCode(ctx, '999')).rejects.toThrow('User not found');
    ...
    it('should throw error if account is already verified', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield expect(userService.resendVerificationCode(ctx, '1')).rejects.toThrow('Account already verified');
        expect(mockCtx.db.user.update).not.toHaveBeenCalled();
    }));
});
